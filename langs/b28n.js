...
(function(window, document) {
  ...
  //__inline('../../langSet.js');
  b28Cfg.supportLang = "en,zh,cs,de,es,laes,nl,ko,fr,hu,it,pl,brpt,pt,ro,ru,tr,uk".split(",");
  ...
  function Butterlation() {
    ...
    this.getLang = function() {
      ...
      if (doc.cookie.indexOf("bLanguage=") === -1) {
        ...
        ret =
          special[local] ||
          special[local.split("-")[0].toString()] ||
      ...
      if (!lang) {
        if (
          ...
          this.options.support.indexOf(this.options.defaultLang) < 0
        ) {
    ...
    this.gettext = function(key) {
      // 不是中文的 同样的英文翻译外文都一样
      if(this.lang !== "cn" && this.lang !== "zh"){
        key = key.replace(/^[a-zA-Z]\#[a-zA-Z][a-zA-Z][a-zA-Z]\#/g, "")
      }
